...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB do seu MultiChatBR que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador MultiChatBR, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar MultiChatBR\n"
  printf "   [1] Atualizar MultiChatBR\n"
  printf "   [2] Deletar MultiChatBR\n"
  printf "   [3] Bloquear MultiChatBR\n"
  printf "   [4] Desbloquear MultiChatBR\n"
  printf "   [5] Alter. dominio MultiChatBR\n"
  printf "\n"
  read -p "> " option
